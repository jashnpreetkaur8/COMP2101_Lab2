...
wget -q -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz && tar -xf ~/public_html/pics/pics.tgz -C ~/public_html/pics --strip-components 1 && rm ~/public_html/pics/pics.tgz
#used tar command with --strip to fetch onlyfiles from the tgz directory.
